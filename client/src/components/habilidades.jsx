...
const Habilidades = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('http://localhost:4000/habilidades', formData)
      .then(response => {
    ...
    axios.post('http://localhost:4000/habilidades', formData)
      .then(response => {
        ...
        toast.success("Registrando datos... Procediendo a Experiencia",
          {
            onClose: () => {
                navigate(`/curriculum/${id}/experiencia`)
            },
            autoClose: 500,
          },
        );
    ...
    <>
      <div className="container mx-auto">
        ...
        <form className="border rounded p-4 mt-4 text-start" method='post'>
          ...
          <button type="submit" onClick={handleContinue} className="bg-green-600 hover:bg-green-800 text-white font-bold py-2 px-4 rounded mr-4">Aceptar y seguir con Experiencia</button>
